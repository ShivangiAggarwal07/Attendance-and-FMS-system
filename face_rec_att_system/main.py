...
while True:
    ...
    ##emotion recognition
    ####
    emotion,scores=fer.predict_emotions(imgS,logits=True)
    cv2.putText(imgBackground,emotion, (861, 125),
    ...
    if faceCurFrame:
        for encodeFace, faceLoc in zip(encodeCurFrame, faceCurFrame):
            ...
            if matches[matchIndex]:
                ...
                if counter == 0:
                    cvzone.putTextRect(imgBackground, emotion, (275, 400))
            ...
            if modeType != 3:
                ...
                if counter <= 10:
                    cv2.putText(imgBackground, str(studentInfo['total attendance']), (861, 125),
                                cv2.FONT_HERSHEY_COMPLEX, 1, (255, 255, 255), 1)
                    cv2.putText(imgBackground, str(studentInfo['professional leave']), (1006, 550),
                                cv2.FONT_HERSHEY_COMPLEX, 0.5, (255, 255, 255), 1)
                    cv2.putText(imgBackground, str(id), (1006, 493),
                                cv2.FONT_HERSHEY_COMPLEX, 0.5, (255, 255, 255), 1)
                    cv2.putText(imgBackground, str(studentInfo['casual leave']), (910, 625),
                                cv2.FONT_HERSHEY_COMPLEX, 0.6, (100, 100, 100), 1)
                    cv2.putText(imgBackground, str(studentInfo['formal leave']), (1025, 625),
                                cv2.FONT_HERSHEY_COMPLEX, 0.6, (100, 100, 100), 1)
                    cv2.putText(imgBackground, str(studentInfo['medical leave']), (1125, 625),
                                cv2.FONT_HERSHEY_COMPLEX, 0.6, (100, 100, 100), 1)
    ...
    cvzone.putTextRect(imgBackground, emotion, (10, 100))
    cv2.imshow("Face Attendance", imgBackground)
    cv2.waitKey(1)